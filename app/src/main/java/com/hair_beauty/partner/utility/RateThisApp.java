    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setPositiveButton("Rate now", new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.dizypay.dizypay")); //https://play.google.com/store/apps/details?id=com.rideeazy.in
                context.startActivity(intent);
                setOptOut(context, true);
                //Toast.makeText(context, "You Have clicked Rate now.", Toast.LENGTH_SHORT).show();
                //sharedPreferenceClass.setValue_int("Rate",1);
